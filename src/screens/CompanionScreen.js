...
const styles = StyleSheet.create({
  ...
  sessionContainer:{ flex: 1, backgroundColor: '#000D26', alignItems: 'center', justifyContent: 'center', gap: 40 },
  companionBadge:  { position: 'absolute', top: 56, paddingHorizontal: 12, paddingVertical: 6, backgroundColor: 'rgba(0,47,167,0.3)', borderRadius: 20, borderWidth: 1, borderColor: 'rgba(0,47,167,0.5)' },
  companionBadgeText:{ color: Colors.purple, fontSize: 10, fontWeight: '700', letterSpacing: 1.5 },
  orb:             { width: 120, height: 120, borderRadius: 60, borderWidth: 1, borderColor: 'rgba(0,47,167,0.35)', shadowColor: Colors.purple, shadowOffset: { width: 0, height: 0 }, shadowOpacity: 0.5, shadowRadius: 30, elevation: 10 },
  phrase:          { color: 'rgba(253,250,244,0.88)', fontSize: 20, fontWeight: '600', textAlign: 'center', lineHeight: 32, paddingHorizontal: 40 },
  timer:           { color: 'rgba(253,250,244,0.18)', fontSize: 13, letterSpacing: 3 },
  endBtn:          { position: 'absolute', bottom: 56, paddingVertical: 14, paddingHorizontal: 32, borderWidth: 1, borderColor: 'rgba(0,47,167,0.3)', borderRadius: 30 },
  endBtnText:      { color: 'rgba(253,250,244,0.4)', fontSize: 13, letterSpacing: 1 },
  stopBtn:         { position: 'absolute', top: 52, left: 24, width: 36, height: 36, alignItems: 'center', justifyContent: 'center' },
  stopBtnText:     { color: 'rgba(253,250,244,0.22)', fontSize: 18 },
});

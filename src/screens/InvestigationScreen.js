...
const s = StyleSheet.create({
  ...
  filterBtn:       { paddingHorizontal: 12, paddingVertical: 7, borderRadius: 20, borderWidth: 1, borderColor: 'rgba(253,250,244,0.1)', backgroundColor: 'rgba(253,250,244,0.03)' },
  filterBtnActive: { backgroundColor: 'rgba(253,250,244,0.1)', borderColor: 'rgba(253,250,244,0.25)' },
  filterText:      { color: Colors.gray, fontSize: 12, fontWeight: '600' },
  filterTextActive:{ color: Colors.white },

  body:     { padding: 16, gap: 8, paddingBottom: 48 },
  introBox: { padding: 13, backgroundColor: 'rgba(253,250,244,0.04)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(253,250,244,0.08)', marginBottom: 4 },
  introText:{ color: 'rgba(253,250,244,0.6)', fontSize: 12, textAlign: 'center', lineHeight: 20 },

  card:        { backgroundColor: 'rgba(253,250,244,0.04)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(253,250,244,0.07)', overflow: 'hidden' },
  ...
  cardChevron: { color: 'rgba(253,250,244,0.25)', fontSize: 18 },
  cardNoteRow: { paddingHorizontal: 13, paddingBottom: 10 },
  cardNoteText:{ color: 'rgba(255,200,100,0.7)', fontSize: 11 },

  footer:      { marginTop: 8, padding: 14, backgroundColor: 'rgba(1,219,238,0.06)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(1,219,238,0.18)', gap: 6 },
  footerTitle: { fontSize: 9, color: Colors.turquoise, letterSpacing: 1.5, fontWeight: '700', textAlign: 'center' },
  footerText:  { color: 'rgba(253,250,244,0.55)', fontSize: 13, textAlign: 'center', lineHeight: 20, fontStyle: 'italic' },

  // ── Détail ──
  detailBody:    { padding: 20, gap: 16, paddingBottom: 48 },
  detailId:      { fontSize: 32, fontWeight: '800', color: 'rgba(253,250,244,0.1)', letterSpacing: 3 },
  ...
  signText:      { color: 'rgba(253,250,244,0.75)', fontSize: 13, lineHeight: 20, flex: 1 },
  ...
  correctionBox: { padding: 14, backgroundColor: 'rgba(253,250,244,0.05)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(253,250,244,0.1)', marginTop: -6 },
  correctionText:{ color: 'rgba(253,250,244,0.8)', fontSize: 13, lineHeight: 21 },
  ruleBox:       { padding: 13, backgroundColor: 'rgba(1,219,238,0.06)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(1,219,238,0.2)' },
  ruleText:      { color: 'rgba(253,250,244,0.5)', fontSize: 12, lineHeight: 19 },
  navRow:        { flexDirection: 'row', alignItems: 'center', marginTop: 8 },
  navBtn:        { paddingVertical: 8, paddingHorizontal: 14, borderRadius: 10, borderWidth: 1, borderColor: 'rgba(253,250,244,0.1)' },

...
const c = StyleSheet.create({
  card:         { backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', overflow: 'hidden' },
  cardComplete: { borderColor: 'rgba(14,224,229,0.3)', backgroundColor: 'rgba(14,224,229,0.03)' },
  cardHeader:   { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 13 },
  progCircle:   { width: 36, height: 36, borderRadius: 18, backgroundColor: 'rgba(128,0,128,0.2)', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: 'rgba(128,0,128,0.4)' },
  progCircleComplete: { backgroundColor: 'rgba(14,224,229,0.15)', borderColor: 'rgba(14,224,229,0.4)' },
  ...
  dateText:     { color: 'rgba(255,255,255,0.25)', fontSize: 10 },
  diffBadge:    { paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6, backgroundColor: 'rgba(219,0,115,0.15)', borderWidth: 1, borderColor: 'rgba(219,0,115,0.35)' },
  diffBadgeText:{ color: Colors.pink, fontSize: 9, fontWeight: '700' },
  chevron:      { color: 'rgba(255,255,255,0.25)', fontSize: 10 },
  barBg:        { height: 3, backgroundColor: 'rgba(255,255,255,0.06)', marginHorizontal: 13 },
  barFill:      { height: '100%', borderRadius: 2 },
  stepsBlock:   { padding: 13, paddingTop: 12, gap: 10 },
  stepRow:      { flexDirection: 'row', alignItems: 'center', gap: 10, padding: 11, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.03)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.07)' },
  stepRowDone:  { backgroundColor: 'rgba(14,224,229,0.05)', borderColor: 'rgba(14,224,229,0.2)' },
  ...
  stepDone:     { width: 28, height: 28, borderRadius: 14, backgroundColor: 'rgba(14,224,229,0.15)', alignItems: 'center', justifyContent: 'center' },
  stepDoneText: { color: Colors.turquoise, fontSize: 14, fontWeight: '700' },
  stepBtn:      { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, backgroundColor: 'rgba(128,0,128,0.2)', borderWidth: 1, borderColor: 'rgba(128,0,128,0.4)' },
  ...
  deleteBtnText:{ color: 'rgba(255,255,255,0.2)', fontSize: 11, textDecorationLine: 'underline' },
});
...
const styles = StyleSheet.create({
  ...
  badge:     { backgroundColor: 'rgba(128,0,128,0.15)', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4, borderWidth: 1, borderColor: 'rgba(128,0,128,0.35)' },
  ...
  globalCard:         { backgroundColor: 'rgba(128,0,128,0.08)', borderRadius: 16, borderWidth: 1, borderColor: 'rgba(128,0,128,0.25)', padding: 20, alignItems: 'center', gap: 8 },
  globalCardCertified:{ backgroundColor: 'rgba(14,224,229,0.07)', borderColor: 'rgba(14,224,229,0.3)' },
  ...
  globalBarBg:        { width: '100%', height: 8, backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 4, overflow: 'hidden' },
  ...
  explainCard:  { backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 14, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)', padding: 16, gap: 12 },
  ...
  input:     { backgroundColor: 'rgba(255,255,255,0.05)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.1)', borderRadius: 12, padding: 13, color: Colors.white, fontSize: 14, minHeight: 52 },
  checkRow:  { flexDirection: 'row', alignItems: 'flex-start', gap: 12, padding: 13, backgroundColor: 'rgba(255,255,255,0.04)', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(255,255,255,0.08)' },
  checkRowActive: { backgroundColor: 'rgba(219,0,115,0.07)', borderColor: 'rgba(219,0,115,0.3)' },
  checkBox:  { width: 22, height: 22, borderRadius: 6, borderWidth: 1.5, borderColor: 'rgba(255,255,255,0.2)', alignItems: 'center', justifyContent: 'center', flexShrink: 0, marginTop: 1 },
